...
// JavaScript code
function showSecondPicture() {
    document.getElementById("headshot").style.display = "none";
    document.getElementById("headshot2").style.display = "block";
  }
  
  function showFirstPicture() {
    document.getElementById("headshot").style.display = "block";
    document.getElementById("headshot2").style.display = "none";
  }
  
  const headshotContainer = document.getElementById("headshot-container");
  headshotContainer.addEventListener("mouseover", showSecondPicture);
  headshotContainer.addEventListener("mouseout", showFirstPicture);
